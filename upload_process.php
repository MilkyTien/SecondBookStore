...
if (isset($_POST["isbn"]) && isset($_POST["bookName"]) && isset($_POST["price"])&& isset($_POST["department"]) && isset($_POST["eduSystem"]) && isset($_POST["major"]) && isset($_POST["grade"])&& isset($_POST["bookCondition"])) {
